		...
		if (estudiar == 1){
			...
			cin >> estudiar_ya;
				if (estudiar_ya == 1){
					...
					cout << "Iniciar la carrera para graduarse"<<endl;
					cout << "¿Iniciará la carrera en la universidad?" << endl << "1. Si 2. No";
					int iniciar;
					cin >> iniciar;
					if (iniciar == 1){
							cout << "¿Terminará la carrera?" << endl << "1. Si 2. No";
						...
						cout << "No estudiará la carrera y no se graduará de la universidad";
					}
				}
		}else {
